...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('assets/css/metisMenu.min') }}class" rel="stylesheet" type="text/css" />
    ...
    <body>
         ...
         <div class="topbar">
            ...
            <!-- LOGO -->
            <div class="topbar-left" style="margin-left: 7%;">
                <a href="/" class="logo">
                    <span>
                        <img src="{{ asset('assets/frontend/upload/logo-1.png') }}" alt="logo-small" class="logo-sm">
                    </span>
                    <span>
                        {{-- <img src="{{ asset('assets/images/logo-sm.png') }}" alt="logo-large" class="logo-lg logo-light"> --}}
                        {{-- <img src="{{ asset('assets/images/logo-sm.png') }}" alt="logo-large" class="logo-lg"> --}}
                    </span>
                </a>
            </div>
            <!--end logo-->
...
{{--                     <li class="dropdown notification-list">
                    ...
                    <li class="dropdown" style="margin-top: -30% !important;">
                        ...
                        <button class="btn btn-lg btn-info fa fa-bars" id="toggle-mob" style="margin-left: -265%; margin-top: 100%;"></button>
                        <div class="dropdown-menu dropdown-menu-right" >
        ...
        <script src="{{ asset('assets/pages/jquery.projects_new.init.js')}}"></script>
