                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Edit Drug Information Below:</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form class="row" id="add-drug-frm" method="post" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" aria-describedby="emailHelp" value="{{$drug->name}}" placeholder="Enter drug name">
                                                    @if ($errors->has('name'))
                                                    ...
                                                    <label class="price-area" for="projectName">Drug Price:<br>
                                                        <small class="req"><i>Required</i></small></label>
                                                    <input type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" aria-describedby="emailHelp" value="{{$drug->price}}" placeholder="Enter drug price">
                                                    @if ($errors->has('price'))
                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="pro-message">Drug Description:<br>
                                                        <small class="req"><i>Required</i></small></label>
                                                    <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" rows="5" id="pro-message"  placeholder="writing here..">{{$drug->description}}</textarea>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <textarea class="form-control{{ $errors->has('how_to_take') ? ' is-invalid' : '' }}" name="how_to_take" rows="5" id="pro-message"  placeholder="writing here..">{{$drug->how_to_take}}</textarea>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    What should be avoided when taking this drug?
                                                        <small><i>Optional</i></small></label>
                                                    <textarea class="form-control{{ $errors->has('avoided') ? ' is-invalid' : '' }}" name="avoided" rows="5" id="pro-message"  placeholder="writing here..">{{$drug->avoided}}</textarea>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    What are the side effects?<br>
                                                        <small><i>Optional</i></small></label>
                                                    <textarea class="form-control{{ $errors->has('side_effects') ? ' is-invalid' : '' }}" name="side_effects" rows="5" id="pro-message"  placeholder="writing here..">{{$drug->side_effects}}</textarea>
                                                 ...
                                                 <div class="form-group col-md-4">
                                                    ...
                                                    What's the dosage?<br>
                                                        <small><i>Optional</i></small></label>
                                                    <textarea class="form-control{{ $errors->has('dosage') ? ' is-invalid' : '' }}" name="dosage" rows="5" id="pro-message"  placeholder="writing here..">{{$drug->dosage}}</textarea>
                                               ...
                                               <div class="action-btns">
                                                 <div class="custom-control custom-checkbox">
                                                    ...
                                                    <button type="submit" class="btn btn-gradient-primary save-drug-btn">Update Drug</button>
                                               </div>
                                            </form>  <!--end form-->
                                        </div><!--end col-->
