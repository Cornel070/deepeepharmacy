                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title dash-title">Deepee Pharmacy & Stores</h4>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card dash-data-card text-center">
                                        <div class="card-body"> 
                                            <div class="icon-info mb-3">
                                                <i class="fa fas fa-tablets"></i>
                                            </div>
                                            <h3 class="text-dark">{{ drugsCount() }}</h3>
                                            <h6 class="font-14 text-dark">Drugs</h6>                                                                                                                            
                                        </div><!--end card-body--> 
                                    </div><!--end card-->   
                                </div><!-- end col-->
                                <div class="col-lg-3">
                                    <div class="card dash-data-card text-center">
                                        <div class="card-body"> 
                                            ...
                                            <h3 class="text-dark">{{ ordersCount() }}</h3>
                                ...
                                <div class="col-lg-3">
                                    <div class="card dash-data-card text-center">
                                        <div class="card-body"> 
                                            <div class="icon-info mb-3">
                                                <i class="fa fas fa-prescription-bottle-alt"></i>
                                            </div>
                                            <h3 class="text-dark">{{ prescsCount() }}</h3>
                                            <h6 class="font-14 text-dark">Prescriptions</h6>                                                                                                                            
                                        </div><!--end card-body--> 
                                    </div><!--end card-->   
                                </div><!-- end col-->
                                <div class="col-lg-3">
                                    <div class="card dash-data-card text-center">
                                        <div class="card-body"> 
                                            ...
                                            <h3 class="text-danger">{{ apptsCount() }}</h3>
                                            <h6 class="font-14 text-dark">Appointments</h6>                                                                                                                            
                                        </div><!--end card-body--> 
                                    </div><!--end card-->   
                                </div><!-- end col-->                       
                            </div><!--end row-->                                                      
                        ...
                        <div class="col-lg-4">                            
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mt-0">Latest Subscribed Emails</h4>
                                   {{--  <div class="happiness-score">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table border-dashed mb-0">
                                            ...
                                            <tr>
                                                <th class="border-bottom-0 {{ $i=1 }}">#</th>
                                                <th class="border-bottom-0 text-right"></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                @foreach(getLatestEmails() as $email)
                                            <tr>
                                                <th class="border-top-0 text-dark" scope="row"></i>{{ $i++ }}</th>
                                                <th class="border-top-0 text-dark" scope="row"></i>{{ $email->email }}</th>
                            ...
                            <div class="card profile-card">
                                <div class="card-body p-0">
                                    <div class="media p-3  align-items-center">                                                
                                        <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="user" class="rounded-circle thumb-xl">                                        
