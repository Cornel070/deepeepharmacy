@extends('layouts.master')
    @section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Enter Prescription Details Below:</h4>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="form-group col-md-9">
                                                        ...
                                                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" aria-describedby="emailHelp" value="{{old('title')}}" placeholder="Enter a title" id="presc-title">
                                                        @if ($errors->has('title'))
                                                ...
                                                <div class="form-group col-md-12">
                                                    <button class="btn btn-gradient-primary save-drug-btn fa fa-plus-circle" id="add-presc">
                                                    Add</button>
        ...
        <form id="presc-add-frm" action="{{ route('store_presc') }}" method="post">
            @csrf
